...
def merged(R_k,f_G,delta_h,r_h,h_m,h_BD):
    return (139.01+42.59*math.log10(f_G))-(14.97+4.99*math.log10(f_G))*extra_math.sgn(delta_h)*math.log10(1+math.fabs(delta_h))+(40.67-4.57*extra_math.sgn(delta_h)*math.log10(1+math.fabs(delta_h))*math.log10(R_k))+correction(r_h,h_m,h_BD)